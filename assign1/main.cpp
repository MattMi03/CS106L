...
{
  /* (STUDENT TODO) Your code goes here... */
  vector<Course> courses_not_offered;
  ofstream file("student_output/courses_offered.csv");
  if (file.is_open())
  {
    ...
    {
      if (course.quarter != "null\r")
      {
        // cout << course.quarter << endl;
        file << course.title << "," << course.number_of_units << "," << course.quarter << "\n";
      }
      else
      {
        courses_not_offered.push_back(course);
      }
    }
    file.close();
  }
...
{
  /* (STUDENT TODO) Your code goes here... */
  ofstream file("student_output/courses_not_offered.csv");
  if (file.is_open())
  {
    file << "Title,Number of Units,Quarter\n";
...
int main()
{
  ...
  vector<Course> courses_not = write_courses_offered(courses);
  write_courses_not_offered(courses_not);
